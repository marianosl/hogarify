<?php
	...
	if(isset($_SESSION['email']) && $_SESSION['rol'] == 0)
	{
		...
		$sql = "update compras set total = '$total', nro_tarjeta = '$nroTarjeta', cod_seguridad = '$codSeguridad' where nro_compra = '$nroCompra';";
		$sqlResultado = mysql_query($sql, $link) or die(redirigirPaginaError(mysql_errno(), mysql_error(), basename($_SERVER['PHP_SELF'])));
		...
		header("Location: modificarCompra.php?nro_compra=$nroCompra&modificado");
	}
	else
	{
